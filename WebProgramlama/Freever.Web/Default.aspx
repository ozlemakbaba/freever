...
<head runat="server">
      ...
      <!-- fevicon -->
      <link rel="icon" href="Resource/Resource/images/fevicon.png" type="image/gif" />
               ...
               <div class="col-lg-3 logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo"> <a href="index.html"><img src="Resource/images/logo.png" alt="#"></a> </div>
                     </div>
                  </div>
               </div>
               <div class="col-lg-9">
                     ...
                     <div class="limit-box">
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              ...
                              <li>
                                 <a href="Resource/about.html">About</a>
                              </li>
                              <li>
                                 <a href="Resource/marketing.html">Marketing</a>
                              </li>
                              <li>
                                 <a href="Resource/blog.html">Blog</a>
                              </li>
                              <li>
                                 <a href="Resource/contact.html">Contact us</a>
                              </li>
                              <li>
                                 <a href="#">Login</a>
                              </li>images/
